...
app.secret_key = 'UU&,dyx)sdkjf#3367'
...
# http://localhost:5000/plogin/ - this will be the login page, we need to use both GET and POST requests
...
# http://localhost:5000/plogout - this will be the logout page
@app.route('/plogout')
def logout():
